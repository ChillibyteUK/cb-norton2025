<?php
/**
 * Block template for CB Text Full-Bleed Image.
 *
...
<section class="split <?= esc_attr( $classes ); ?>">
	<div class="container-fluid">
		...
		<div class="row g-0 align-items-center h-100">
			...
			<div class="col-lg-6 d-flex align-items-center <?= esc_attr( $text_order ); ?>">
				<div class="split__copy container <?= esc_attr( $text_alignment ); ?>" data-aos="<?= esc_attr( $text_aos ); ?>">
